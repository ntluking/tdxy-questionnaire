...
<div id="w">
    <nav>
        <ul id="ddmenu">
            ...
            <li><a href="<?php echo U('Modify/modify');?>">修改密码</a>
...
<div class="container">
    ...
    <div id="search">
        <form action="<?php echo U('Modify/modify');?>" enctype="multipart/form-data" method="POST" accept-charset="utf-8">
            旧 密 码：<input type="password" name="passwd_old" value="" placeholder="旧密码"><br>
            <br>
            新 密 码：<input type="password" name="passwd_new" value="" placeholder="新密码"><br>
            <br>
    ...
    <div>
        <div>
            <h2 style="color: red"><?php echo ($manage_success); ?></h2>
        </div>
        <div>
