...
<div class="content">
    ...
    <div class="main">
        ...
        <!-- <h5>
            ...
            <div style="float: left;">
                <select name="schoolbranch">
                    <option name="sci" value="0" selected="selected">理科</option>
                    <option name="arts" value="1">文科</option>
                </select>
            </div>
        </h5> -->
...
<script type="text/javascript">
    ...
    /*function clickRadio() {
        if(document.getElementById('selected1').checked==false){
            document.getElementById('selected1').checked=true;
        }
        else if(document.getElementById('selected1').checked==true){
